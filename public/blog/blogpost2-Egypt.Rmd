...
```{r cumulative-egypt, fig.cap="Summary of cumulative cases in Egypt.", fig.align="centre"}
egypt_wrangled %>%
  ggplot() +
...
To understand the effect of COVID-19 to the economy, we are looking at the stock prices of EGX30 stock index. Here, the log of the Price is used instead of just price to allow better comparison.
...
```{r stock-movement, fig.cap="Movement of stcok prices of top 30 companies in Egypt."}
