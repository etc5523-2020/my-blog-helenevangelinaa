...
data_wrangled %>%
  ...
  widgetframe::frameWidget(width = "700")
```
...
sparkline_cor %>%
  widgetframe::frameWidget(width = "700", height = "300")
```
...
--
This blog is made with roxo-hugo from Blogdown, alongside with...
