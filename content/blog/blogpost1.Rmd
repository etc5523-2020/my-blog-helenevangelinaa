...
-  **apple_mtr_driving**: Apple Maps usage for driving directions, as percentage x 100 relative to the baseline of Jan 13, 2020 (similar description for other `appl_mtr` variables)  
- **gcmr_retail_recreation**: Google Community Mobility Reports data for the frequency that people visit retail and recreation places expressed as a percentage*100 change relative to the baseline period Jan 3 - Feb 6, 2020 (similar description for other `gcmr` variables)
