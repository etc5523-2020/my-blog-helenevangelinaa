...
adding the slider input for figure 2
...
Bar charts as seen in (https://informationisbeautiful.net/visualizations/covid-19-coronavirus-infographic-datapack/)
...
All these improvements would establish the dashboard more (expand the scope) of analysis and present readers with a more detailed information.
